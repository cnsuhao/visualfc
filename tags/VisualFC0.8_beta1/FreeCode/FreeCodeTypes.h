...
/* at Tue Apr 22 19:53:48 2008
 */
/* Compiler settings for F:\VFC_Projects\ClsWizard\FreeCode\FreeCode.odl:
...
DEFINE_GUID(IID_ICommands,0xA5B5FB6C,0x1BBE,0x4B0F,0xB3,0x8D,0x2A,0xF0,0xD9,0x22,0xC9,0x58);
    ...
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE VFCWizard( void) = 0;
    ...
    typedef struct ICommandsVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *VFCWizard )( 
            ICommands __RPC_FAR * This);
...
#define ICommands_VFCWizard(This)	\
    (This)->lpVtbl -> VFCWizard(This)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ICommands_VFCWizard_Proxy( 
    ICommands __RPC_FAR * This);


void __RPC_STUB ICommands_VFCWizard_Stub(
    IRpcStubBuffer *This,
