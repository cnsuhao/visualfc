...
bool CCommands::add_project_file(const char * file)
{
...
const char * CCommands::get_project_path()
{
...
const char * CCommands::get_project_name()
{
...
void CCommands::SetApplicationObject(IApplication* pApplication)
{
	...
	m_fc.load(_Module.m_hInst,this);
	m_fc.create();
}
...
//DEL STDMETHODIMP CCommands::WTLWizard()
//DEL {
//DEL 	// TODO: Add your implementation code here
//DEL 	VERIFY_OK(m_pApplication->EnableModeless(VARIANT_FALSE));
//DEL 
...
//DEL 	{
//DEL 		this->SaveAllDocuments();
//DEL 		CComBSTR	ActiveFileName("");		
//DEL 		CComPtr<IDispatch> ActiveProject;
//DEL 		CComPtr<IDispatch> ActiveDocument;
//DEL 		m_pApplication->get_ActiveProject(&ActiveProject);
//DEL 		m_pApplication->get_ActiveDocument(&ActiveDocument);
//DEL 		CComQIPtr<IGenericProject, &IID_IGenericProject> pActiveProject(ActiveProject);	
//DEL 		CComQIPtr<IGenericDocument, &IID_IGenericDocument> pActiveDocument(ActiveDocument);
//DEL 		if (pActiveDocument)
//DEL 		{
//DEL 			pActiveDocument->get_Name(&ActiveFileName);
//DEL 		}
//DEL 		else
//DEL 		{
//DEL 			ActiveFileName = _T("");
//DEL 		}
//DEL 		if (pActiveProject)
//DEL 		{
//DEL 			CComBSTR name;
...
//DEL 			pActiveProject->get_Name(&name);
//DEL 
//DEL 			m_dsp.load_dsp((CString)path);
//DEL 			
//DEL 			m_fc.pwtl->load_project(GetActiveWindow(),(CString)name,(CString)ActiveFileName,false);
//DEL 		}
//DEL 	}
//DEL 	VERIFY_OK(m_pApplication->EnableModeless(VARIANT_TRUE));
//DEL 
...
//DEL STDMETHODIMP CCommands::WINXWizard()
//DEL {
//DEL 	// TODO: Add your implementation code here
//DEL 	VERIFY_OK(m_pApplication->EnableModeless(VARIANT_FALSE));
//DEL 	if (m_fc.pwinx)
...
//DEL 			m_dsp.load_dsp((CString)path);
//DEL 			
//DEL 			m_fc.pwinx->load_project(GetActiveWindow(),(CString)name,(CString)ActiveFileName,false);
//DEL 		}
//DEL 	}
//DEL 	VERIFY_OK(m_pApplication->EnableModeless(VARIANT_TRUE));
//DEL 
...
//DEL STDMETHODIMP CCommands::Options()
//DEL {
//DEL 	// TODO: Add your implementation code here
//DEL 
//DEL 	return S_OK;
...
STDMETHODIMP CCommands::VFCWizard()
{
	// TODO: Add your implementation code here
 	...
 	if (m_fc.pvfc)
 	{
 		...
 		if (pActiveProject)
 		{
 			...
 			m_fc.pvfc->load_project(GetActiveWindow(),(CString)name,(CString)ActiveFileName,false);
 		}
		else
		{
			m_fc.pvfc->load_project(GetActiveWindow(),NULL,NULL,false);
		}
 	}
